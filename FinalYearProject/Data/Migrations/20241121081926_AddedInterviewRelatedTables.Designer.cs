...
namespace FinalYearProject.Data.Migrations
{
    ...
    [Migration("20241121081926_AddedInterviewRelatedTables")]
    partial class AddedInterviewRelatedTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalYearProject.Models.AdditionalSalary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalYearProject.Models.Attachment", b =>
                {
            ...
            modelBuilder.Entity("FinalYearProject.Models.CompanyKPI", b =>
                {
                    ...
                    b.Property<float>("CurrentProgress")
                        .HasColumnType("real");
                    ...
                    b.Property<float?>("hit_KPI_allowance")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("FinalYearProject.Models.EmployeeKPI", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmployeeKPIId"));
            ...
            modelBuilder.Entity("FinalYearProject.Models.IntervieweeProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("IntervieweeProgress");
                });

            modelBuilder.Entity("FinalYearProject.Models.KPIReward", b =>
                {
            ...
            modelBuilder.Entity("FinalYearProject.Models.Notification", b =>
                {
                    ...
                    b.Property<string>("notification_receiver")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FinalYearProject.Models.ProofSubmission", b =>
                {
                    b.Property<int>("ProofSubmissionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProofSubmissionId"));
            ...
            modelBuilder.Entity("FinalYearProject.Models.Report", b =>
                {
                    ...
                    b.Property<string>("report_receiver")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("report_sender");

                    b.ToTable("Report");
                });

            modelBuilder.Entity("FinalYearProject.Models.ReportFeedback", b =>
                {
            ...
            modelBuilder.Entity("FinalYearProject.Models.Training", b =>
                {
                    ...
                    b.Property<string>("training_link")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FinalYearProject.Models.AdditionalSalary", b =>
                {
                    b.HasOne("FinalYearProject.Models.EmployeeClaim", "Claim")
                        .WithMany()
                        .HasForeignKey("ClaimId");

                    b.HasOne("FinalYearProject.Models.EmployeeDetails", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("FinalYearProject.Models.Attachment", b =>
                {
                    b.HasOne("FinalYearProject.Models.Report", "Report")
            ...
            modelBuilder.Entity("FinalYearProject.Models.EmployeeKPI", b =>
                {
                    b.HasOne("FinalYearProject.Models.CompanyKPI", "CompanyKPI")
                        .WithMany()
                        .HasForeignKey("KPI_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompanyKPI");
                });
            ...
            modelBuilder.Entity("FinalYearProject.Models.Report", b =>
                {
                    b.HasOne("FinalYearProject.Models.EmployeeDetails", "SendByEmployee")
                        .WithMany()
                        .HasForeignKey("report_sender")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SendByEmployee");
                });
